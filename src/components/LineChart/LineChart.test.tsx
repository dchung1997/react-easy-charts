...
describe("Interactivity Line Chart", () => {
    test("Linechart Tooltip.", () => {
        ...
        fireEvent.mouseOver(screen.getByTestId('linechart-svg'));
        expect(component).toMatchSnapshot();

        fireEvent.mouseMove(screen.getByTestId('linechart-svg'));
        expect(component).toMatchSnapshot();

        fireEvent.mouseOut(screen.getByTestId('linechart-svg'));
        expect(component).toMatchSnapshot();
    });

    test("Linechart legend data selection.", () => {
        const component = render(<LineChart data={        
            [
                {
                    id: 1,
        ...
        // expect(screen.getByTestId("linechart-tooltip"))
    });
